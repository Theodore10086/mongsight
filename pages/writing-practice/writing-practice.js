...
Page({
  ...
  _initUserIdentity() {
    ...
    const hasCompletedOnboarding = !!(wx.getStorageSync('hasCompletedOnboarding') || wx.getStorageSync('hasGuided'))

    if (cachedUserInfo) {
      this.setData({
        identityState: 'AUTH_SUCCESS',
        userProfile: cachedUserInfo,
        hasGuided: hasCompletedOnboarding,
        guideEnabled: false
      })
